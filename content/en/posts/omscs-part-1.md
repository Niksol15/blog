...
4. **[University of Texas at Austin](https://cdso.utexas.edu/mscs)**, known as MSCSO. The price is $10k for 10 courses. However, it has more limited selection of 18 courses. They also have specialized programs for Data Science: [MSDSO](https://cdso.utexas.edu/msds) and AI: [MSAIO](https://cdso.utexas.edu/msai).
...
Besides OMSCS, GaTech also offers separate programs in data analytics [OMSA](https://pe.gatech.edu/degrees/analytics) and cybersecurity [OMSC](https://pe.gatech.edu/degrees/cybersecurity). However, I'll focus specifically on OMSCS. I highly recommend browsing the internet about OMSCS beforehand, especially [Reddit](https://www.reddit.com/r/OMSCS/).
